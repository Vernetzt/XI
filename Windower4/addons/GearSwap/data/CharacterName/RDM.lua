...
function get_sets()
    ...
    sets.me.melee.normaldw = set_combine(sets.me.idle.refresh,{   
        ...
        hands="Malignance Gloves",
        legs="Malignance Tights",
        feet={ name="Taeon Boots", augments={'Accuracy+25','"Dual Wield"+4'}},
        neck="Anu Torque",
        waist="Reiki Yotai",
    ...
    sets.midcast.AyanmoHands = {
        hands="Ayanmo Manopolas +2", -- Commented cause I dont have one yet
    }
	-----------------------------------------------------------------------------------------------
    ...
    sets.midcast.Enfeebling.macc = {
        ...
        legs={ name="Chironic Hose", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','"Conserve MP"+3','VIT+7','Mag. Acc.+14','"Mag.Atk.Bns."+6',}},
        feet=RELIC.Feet,
        neck="Dls. Torque +2",
        waist="Luminary Sash",
        left_ear="Regal Earring",
