...
hud_y_pos = 490     --important to update these if you have a smaller screen
hud_draggable = true
hud_font_size = 10
...
function get_sets()
    ...
    -- All sets that are equipped to faciliate my avatar's behaviour or abilities are under 'avatar', eg, Perpetuation, Blood Pacts, etc
		...
		AF.Body		=	"Acad. Gown +3"
		AF.Hands	=	"Acad. Bracers +2"
		AF.Legs		=	"Acad. Pants +2"
		AF.Feet		=	"Acad. Loafers +3"

		--Vitiation
		RELIC.Head		=	"Peda. M.Board +3"
		RELIC.Body		=	"Peda. Gown +1"
		RELIC.Hands 	=	""
		RELIC.Legs		=	"Pedagogy Pants"
    ...
    -- Define JSE Capes
    SCHCape = {}
    SCHCape.MND = { name="Lugh's Cape", augments={'MND+10','Mag. Acc+20 /Mag. Dmg.+20','"Fast Cast"+10','Mag. Evasion+12',}}
