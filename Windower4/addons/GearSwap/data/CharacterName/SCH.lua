...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
hud_x_pos = 1770    --important to update these if you have a smaller screen
hud_y_pos = 700     --important to update these if you have a smaller screen
hud_draggable = true
hud_font_size = 10
...
idleModes = M('refresh', 'dt', 'mdt', 'flee')
...
function get_sets()
    ...
    sets.me.idle.refresh = {
			...
			head="Befouled Crown",
			body="Jhakri Robe +2",
			hands={ name="Gende. Gages +1", augments={'Phys. dmg. taken -4%','Magic dmg. taken -3%','"Cure" spellcasting time -4%',}},
			legs="Assid. Pants +1",
			...
			back={ name="Lugh's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Damage taken-5%',}},
	}
	...
	sets.me.idle.dt = set_combine(sets.me.idle[refreshType],{
			...
			head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+1','Phys. dmg. taken -4%',}},
...
-- Combat Related Sets
    ...
    sets.precast.casting = {
			main={ name="Grioavolr", augments={'Enfb.mag. skill +15','Mag. Acc.+13','"Mag.Atk.Bns."+18',}},                                 -- 4
			sub="Enki Strap",
			ammo="Sapience Orb",                                                                                                            -- 2
			head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+17','"Fast Cast"+4','INT+5',}},                                          -- 12
			body="Jhakri Robe +2",
			hands={ name="Gende. Gages +1", augments={'Phys. dmg. taken -4%','Magic dmg. taken -3%','"Cure" spellcasting time -4%',}},      -- 7
			legs={ name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}},                                             -- 7
			feet={ name="Merlinic Crackows", augments={'Mag. Acc.+9 "Mag.Atk.Bns."+9','"Fast Cast"+6','CHR+10','Mag. Acc.+2',}},            -- 11
			...
			back={ name="Lugh's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10',}},                   -- 10
	}
...
sets.midcast.MB.normal = set_combine(sets.midcast.nuking.normal, {
		...
		-- hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
		-- legs={ name="Amalric Slops +1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
		feet={ name="Merlinic Crackows", augments={'Mag. Acc.+28','Magic burst dmg.+7%','"Mag.Atk.Bns."+13',}},
		-- neck="Mizu. Kubikazari",
		-- waist="Eschan Stone",
...
sets.midcast.IntEnfeebling = {
	main={ name="Grioavolr", augments={'Enfb.mag. skill +15','Mag. Acc.+13','"Mag.Atk.Bns."+18',}},
	sub="Enki Strap",
	ammo="Pemphredo Tathlum",
	head="Jhakri Coronal +2",
	body="Amalric Doublet +1",
	hands="Jhakri Cuffs +2",
	legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Fast Cast"+5','INT+8','Mag. Acc.+15','"Mag.Atk.Bns."+10',}},
    ...
    ------------	
		...
		-- Focus on Regen Potency 	
			sets.midcast.regen.potency = set_combine(sets.midcast.regen.hybrid,{
					...
					-- left_ring="Warp Ring",
					-- right_ring="Lebeche Ring",
					back={ name="Bookworm's Cape", augments={'INT+3','MND+4','Helix eff. dur. +19','"Regen" potency+8',}},
			}) 
